...
const Careers = () => {
  const seoKeywords = [
    ...
    'IT services careers',
    'software solutions jobs',
    'enterprise software careers',
    'tech startup jobs'
  ].join(', ');

  const seoDescription = 'Join OneTechFuse - A leading IT solutions and software development company. Explore exciting career opportunities in software engineering, DevOps, Salesforce, mobile development, and more. Remote positions available with competitive benefits and growth opportunities.';
  ...
  return (
    <>
      <Helmet>
        <title>Careers at OneTechFuse | Software & IT Solutions Jobs</title>
